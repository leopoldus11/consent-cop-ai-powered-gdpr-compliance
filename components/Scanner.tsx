...
export const Scanner: React.FC<ScannerProps> = ({ onScanStart, isLoading }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto h-full flex flex-col justify-center pt-4 sm:pt-8 lg:pt-16 pb-4 sm:pb-12 lg:pb-16 px-4 sm:px-6 lg:px-4">
      ...
      {!user ? (
        <div className="mb-3 sm:mb-8 lg:mb-10 bg-blue-50 border border-blue-200 rounded-xl p-3 sm:p-5 flex-shrink-0">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-xl p-4 sm:p-8 lg:p-12 mb-0 sm:mb-8 lg:mb-10 flex-shrink-0">
