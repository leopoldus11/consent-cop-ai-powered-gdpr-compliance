...
export const Scanner: React.FC<ScannerProps> = ({ onScanStart, isLoading }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto pt-6 sm:pt-8 lg:pt-16 pb-8 sm:pb-12 lg:pb-16 px-4 sm:px-6">
      ...
      <div className="text-center mb-8 sm:mb-10 lg:mb-16">
        ...
        <p className="sm:hidden text-sm text-slate-600 max-w-md mx-auto leading-relaxed mb-6">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-xl p-6 sm:p-8 lg:p-12 mb-6 sm:mb-8 lg:mb-10">
