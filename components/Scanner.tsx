...
export const Scanner: React.FC<ScannerProps> = ({ onScanStart, isLoading }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto h-full px-4 sm:px-6 lg:px-4">
      {/* Mobile: CSS Grid layout for perfect viewport distribution */}
      <div className="h-full grid grid-rows-[auto_auto_auto_1fr] sm:grid-rows-[auto_auto_auto_auto] gap-3 sm:gap-6 lg:gap-8 sm:pt-8 lg:pt-16 sm:pb-12 lg:pb-16">
        {/* Row 1: Hero Section */}
