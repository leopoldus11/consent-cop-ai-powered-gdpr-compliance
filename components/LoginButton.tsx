...
export const LoginButton: React.FC<LoginButtonProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="flex items-center space-x-2 bg-white border border-slate-200 px-4 py-2 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {isLoading ? (
        <>
